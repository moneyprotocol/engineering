...
[Home](./index.md) &gt; [@moneyprotocol/lib-ethers](./lib-ethers.md) &gt; [SendableBitcoinsMoneyp](./lib-ethers.sendablebitcoinsmoneyp.md) &gt; [openVault](./lib-ethers.sendablebitcoinsmoneyp.openvault.md)

## SendableBitcoinsMoneyp.openVault() method
...
Promise&lt;[SentBitcoinsMoneypTransaction](./lib-ethers.sentbitcoinsmoneyptransaction.md)<!-- -->&lt;[VaultCreationDetails](./lib-base.vaultcreationdetails.md)<!-- -->&gt;&gt;
