...
[Home](./index.md) &gt; [@moneyprotocol/lib-base](./lib-base.md) &gt; [MoneypReceipt](./lib-base.moneypreceipt.md)
...
```typescript
export declare type MoneypReceipt<R = unknown, D = unknown> = PendingReceipt | MinedReceipt<R, D>;
```
