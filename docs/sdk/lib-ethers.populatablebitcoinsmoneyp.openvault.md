...
[Home](./index.md) &gt; [@moneyprotocol/lib-ethers](./lib-ethers.md) &gt; [PopulatableBitcoinsMoneyp](./lib-ethers.populatablebitcoinsmoneyp.md) &gt; [openVault](./lib-ethers.populatablebitcoinsmoneyp.openvault.md)

## PopulatableBitcoinsMoneyp.openVault() method
...
Promise&lt;[PopulatedBitcoinsMoneypTransaction](./lib-ethers.populatedbitcoinsmoneyptransaction.md)<!-- -->&lt;[VaultCreationDetails](./lib-base.vaultcreationdetails.md)<!-- -->&gt;&gt;
