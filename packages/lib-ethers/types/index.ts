...
interface ActivePoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _vaultManagerAddress: string, _stabilityPoolAddress: string, _defaultPoolAddress: string, _overrides?: Overrides): Promise<void>;
}
...
export interface ActivePool
  ...
  extractEvents(logs: Log[], name: "ActivePoolBPDDebtUpdated"): _TypedLogDescription<{ _BPDDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "ActivePoolRBTCBalanceUpdated"): _TypedLogDescription<{ _RBTC: BigNumber }>[];
  extractEvents(logs: Log[], name: "BPDBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "BitcoinSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "VaultManagerAddressChanged"): _TypedLogDescription<{ _newVaultManagerAddress: string }>[];
}
...
interface BorrowerOperationsTransactions {
  ...
  adjustVault(_maxFeePercentage: BigNumberish, _collWithdrawal: BigNumberish, _BPDChange: BigNumberish, _isDebtIncrease: boolean, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  claimCollateral(_overrides?: Overrides): Promise<void>;
  closeVault(_overrides?: Overrides): Promise<void>;
  moveRBTCGainToVault(_borrower: string, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  openVault(_maxFeePercentage: BigNumberish, _BPDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  repayBPD(_BPDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_vaultManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedVaultsAddress: string, _bpdTokenAddress: string, _mpStakingAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawBPD(_maxFeePercentage: BigNumberish, _BPDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
...
export interface BorrowerOperations
  extends _TypedMoneypContract<BorrowerOperationsCalls, BorrowerOperationsTransactions> {
  readonly filters: {
    ...
    VaultManagerAddressChanged(_newVaultManagerAddress?: null): EventFilter;
    VaultUpdated(_borrower?: string | null, _debt?: null, _coll?: null, stake?: null, operation?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _activePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "BPDBorrowingFeePaid"): _TypedLogDescription<{ _borrower: string; _BPDFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "BPDTokenAddressChanged"): _TypedLogDescription<{ _bpdTokenAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "MPStakingAddressChanged"): _TypedLogDescription<{ _mpStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "SortedVaultsAddressChanged"): _TypedLogDescription<{ _sortedVaultsAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "VaultCreated"): _TypedLogDescription<{ _borrower: string; arrayIndex: BigNumber }>[];
  extractEvents(logs: Log[], name: "VaultManagerAddressChanged"): _TypedLogDescription<{ _newVaultManagerAddress: string }>[];
  extractEvents(logs: Log[], name: "VaultUpdated"): _TypedLogDescription<{ _borrower: string; _debt: BigNumber; _coll: BigNumber; stake: BigNumber; operation: number }>[];
}
...
interface CollSurplusPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _vaultManagerAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CollSurplusPool
  extends _TypedMoneypContract<CollSurplusPoolCalls, CollSurplusPoolTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    BitcoinSent(_to?: null, _amount?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
...
interface CommunityIssuanceTransactions {
  ...
  sendMP(_account: string, _MPamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_mpTokenAddress: string, _stabilityPoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CommunityIssuance
  extends _TypedMoneypContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
  readonly filters: {
  ...
  extractEvents(logs: Log[], name: "MPTokenAddressSet"): _TypedLogDescription<{ _mpTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressSet"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "TotalMPIssuedUpdated"): _TypedLogDescription<{ _totalMPIssued: BigNumber }>[];
}
...
interface DefaultPoolTransactions {
  ...
  setAddresses(_vaultManagerAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
}
...
export interface DefaultPool
  ...
  extractEvents(logs: Log[], name: "BitcoinSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _newDefaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "DefaultPoolBPDDebtUpdated"): _TypedLogDescription<{ _BPDDebt: BigNumber }>[];
...
interface HintHelpersCalls {
  ...
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionHints(_BPDamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{ firstRedemptionHint: string; partialRedemptionHintNICR: BigNumber; truncatedBPDamount: BigNumber }>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedVaults(_overrides?: CallOverrides): Promise<string>;
...
interface HintHelpersTransactions {
  setAddresses(_sortedVaultsAddress: string, _vaultManagerAddress: string, _overrides?: Overrides): Promise<void>;
}
...
export interface HintHelpers
  ...
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SortedVaultsAddressChanged"): _TypedLogDescription<{ _sortedVaultsAddress: string }>[];
  extractEvents(logs: Log[], name: "VaultManagerAddressChanged"): _TypedLogDescription<{ _vaultManagerAddress: string }>[];
}
...
interface LockupContractFactoryTransactions {
  ...
  setMPTokenAddress(_mpTokenAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface LockupContractFactory
  extends _TypedMoneypContract<LockupContractFactoryCalls, LockupContractFactoryTransactions> {
  readonly filters: {
...
export interface BPDToken
  ...
  extractEvents(logs: Log[], name: "Approval"): _TypedLogDescription<{ owner: string; spender: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "BPDTokenBalanceUpdated"): _TypedLogDescription<{ _user: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "VaultManagerAddressChanged"): _TypedLogDescription<{ _vaultManagerAddress: string }>[];
...
interface MPStakingCalls {
  ...
  borrowerOperationsAddress(_overrides?: CallOverrides): Promise<string>;
  bpdToken(_overrides?: CallOverrides): Promise<string>;
  getPendingBPDGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingRBTCGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  mpToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  snapshots(arg0: string, _overrides?: CallOverrides): Promise<{ F_RBTC_Snapshot: BigNumber; F_BPD_Snapshot: BigNumber }>;
...
interface MPStakingTransactions {
  ...
  setAddresses(_mpTokenAddress: string, _bpdTokenAddress: string, _vaultManagerAddress: string, _borrowerOperationsAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
...
export interface MPStaking
  ...
  readonly filters: {
    ...
    StakerSnapshotsUpdated(_staker?: null, _F_RBTC?: null, _F_BPD?: null): EventFilter;
    StakingGainsWithdrawn(staker?: string | null, BPDGain?: null, RBTCGain?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "BPDTokenAddressSet"): _TypedLogDescription<{ _bpdTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "BitcoinSent"): _TypedLogDescription<{ _account: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressSet"): _TypedLogDescription<{ _borrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "F_BPDUpdated"): _TypedLogDescription<{ _F_BPD: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "StakerSnapshotsUpdated"): _TypedLogDescription<{ _staker: string; _F_RBTC: BigNumber; _F_BPD: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakingGainsWithdrawn"): _TypedLogDescription<{ staker: string; BPDGain: BigNumber; RBTCGain: BigNumber }>[];
  extractEvents(logs: Log[], name: "TotalMPStakedUpdated"): _TypedLogDescription<{ _totalMPStaked: BigNumber }>[];
  extractEvents(logs: Log[], name: "VaultManagerAddressSet"): _TypedLogDescription<{ _vaultManager: string }>[];
}
...
interface MPTokenTransactions {
  ...
  increaseAllowance(spender: string, addedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  permit(owner: string, spender: string, amount: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, _overrides?: Overrides): Promise<void>;
  sendToMPStaking(_sender: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  transfer(recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  transferFrom(sender: string, recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
}
...
export interface MPToken
  ...
  extractEvents(logs: Log[], name: "MPStakingAddressSet"): _TypedLogDescription<{ _mpStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
}

interface MultiVaultGetterCalls {
  getMultipleSortedVaults(_startIdx: BigNumberish, _count: BigNumberish, _overrides?: CallOverrides): Promise<{ owner: string; debt: BigNumber; coll: BigNumber; stake: BigNumber; snapshotRBTC: BigNumber; snapshotBPDDebt: BigNumber }[]>;
  sortedVaults(_overrides?: CallOverrides): Promise<string>;
  vaultManager(_overrides?: CallOverrides): Promise<string>;
}
...
export interface MultiVaultGetter
  extends _TypedMoneypContract<MultiVaultGetterCalls, MultiVaultGetterTransactions> {
  readonly filters: {
  };
}
...
export interface PriceFeedTestnet
  extends _TypedMoneypContract<PriceFeedTestnetCalls, PriceFeedTestnetTransactions> {
  readonly filters: {
    LastGoodPriceUpdated(_lastGoodPrice?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "LastGoodPriceUpdated"): _TypedLogDescription<{ _lastGoodPrice: BigNumber }>[];
...
interface SortedVaultsTransactions {
  ...
  setParams(_size: BigNumberish, _vaultManagerAddress: string, _borrowerOperationsAddress: string, _overrides?: Overrides): Promise<void>;
}
...
export interface SortedVaults
  ...
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SortedVaultsAddressChanged"): _TypedLogDescription<{ _sortedDoublyLLAddress: string }>[];
  extractEvents(logs: Log[], name: "VaultManagerAddressChanged"): _TypedLogDescription<{ _vaultManagerAddress: string }>[];
}
...
interface StabilityPoolCalls {
  ...
  getCompoundedBPDDeposit(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getCompoundedFrontEndStake(_frontEnd: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorMPGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorRBTCGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getFrontEndMPGain(_frontEnd: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getRBTC(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _vaultManagerAddress: string, _activePoolAddress: string, _bpdTokenAddress: string, _sortedVaultsAddress: string, _priceFeedAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawFromSP(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  withdrawRBTCGainToVault(_upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}
...
export interface StabilityPool
  ...
  readonly filters: {
    ...
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    RBTCGainWithdrawn(_depositor?: string | null, _RBTC?: null, _BPDLoss?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _newActivePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "BPDTokenAddressChanged"): _TypedLogDescription<{ _newBPDTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "BitcoinSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "MPPaidToDepositor"): _TypedLogDescription<{ _depositor: string; _MP: BigNumber }>[];
  extractEvents(logs: Log[], name: "MPPaidToFrontEnd"): _TypedLogDescription<{ _frontEnd: string; _MP: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "P_Updated"): _TypedLogDescription<{ _P: BigNumber }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "RBTCGainWithdrawn"): _TypedLogDescription<{ _depositor: string; _RBTC: BigNumber; _BPDLoss: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "SortedVaultsAddressChanged"): _TypedLogDescription<{ _newSortedVaultsAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolBPDBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
...
interface VaultManagerCalls {
  ...
  Vaults(arg0: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; stake: BigNumber; status: number; arrayIndex: BigNumber }>;
  _100pct(_overrides?: CallOverrides): Promise<BigNumber>;
  activePool(_overrides?: CallOverrides): Promise<string>;
  ...
  defaultPool(_overrides?: CallOverrides): Promise<string>;
  getBorrowingFee(_BPDDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  getBorrowingFeeWithDecay(_BPDDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getEntireDebtAndColl(_borrower: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; pendingBPDDebtReward: BigNumber; pendingRBTCReward: BigNumber }>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getNominalICR(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingBPDDebtReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getVaultColl(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getVaultDebt(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getVaultFromVaultOwnersArray(_index: BigNumberish, _overrides?: CallOverrides): Promise<string>;
  getVaultOwnersCount(_overrides?: CallOverrides): Promise<BigNumber>;
  getVaultStake(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getVaultStatus(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  hasPendingRewards(_borrower: string, _overrides?: CallOverrides): Promise<boolean>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastBPDDebtError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  rewardSnapshots(arg0: string, _overrides?: CallOverrides): Promise<{ RBTC: BigNumber; BPDDebt: BigNumber }>;
  sortedVaults(_overrides?: CallOverrides): Promise<string>;
...
interface VaultManagerTransactions {
  addVaultOwnerToArray(_borrower: string, _overrides?: Overrides): Promise<BigNumber>;
  applyPendingRewards(_borrower: string, _overrides?: Overrides): Promise<void>;
  batchLiquidateVaults(_vaultArray: string[], _overrides?: Overrides): Promise<void>;
  ...
  decreaseVaultColl(_borrower: string, _collDecrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  decreaseVaultDebt(_borrower: string, _debtDecrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  increaseVaultColl(_borrower: string, _collIncrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  increaseVaultDebt(_borrower: string, _debtIncrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  ...
  redeemCollateral(_BPDamount: BigNumberish, _firstRedemptionHint: string, _upperPartialRedemptionHint: string, _lowerPartialRedemptionHint: string, _partialRedemptionHintNICR: BigNumberish, _maxIterations: BigNumberish, _maxFeePercentage: BigNumberish, _overrides?: Overrides): Promise<void>;
  removeStake(_borrower: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _bpdTokenAddress: string, _sortedVaultsAddress: string, _mpTokenAddress: string, _mpStakingAddress: string, _overrides?: Overrides): Promise<void>;
  setVaultStatus(_borrower: string, _num: BigNumberish, _overrides?: Overrides): Promise<void>;
  updateStakeAndTotalStakes(_borrower: string, _overrides?: Overrides): Promise<BigNumber>;
  updateVaultRewardSnapshots(_borrower: string, _overrides?: Overrides): Promise<void>;
}
...
export interface VaultManager
  ...
  readonly filters: {
    ...
    Liquidation(_liquidatedDebt?: null, _liquidatedColl?: null, _collGasCompensation?: null, _BPDGasCompensation?: null): EventFilter;
    MPStakingAddressChanged(_mpStakingAddress?: null): EventFilter;
    MPTokenAddressChanged(_mpTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    Redemption(_attemptedBPDAmount?: null, _actualBPDAmount?: null, _RBTCSent?: null, _RBTCFee?: null): EventFilter;
    SortedVaultsAddressChanged(_sortedVaultsAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ...
    VaultLiquidated(_borrower?: string | null, _debt?: null, _coll?: null, _operation?: null): EventFilter;
    VaultSnapshotsUpdated(_B_RBTC?: null, _B_BPDDebt?: null): EventFilter;
    VaultUpdated(_borrower?: string | null, _debt?: null, _coll?: null, _stake?: null, _operation?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _activePoolAddress: string }>[];
  extractEvents(logs: Log[], name: "BPDTokenAddressChanged"): _TypedLogDescription<{ _newBPDTokenAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _defaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "GasPoolAddressChanged"): _TypedLogDescription<{ _gasPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "LTermsUpdated"): _TypedLogDescription<{ _B_RBTC: BigNumber; _B_BPDDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "LastFeeOpTimeUpdated"): _TypedLogDescription<{ _lastFeeOpTime: BigNumber }>[];
  extractEvents(logs: Log[], name: "Liquidation"): _TypedLogDescription<{ _liquidatedDebt: BigNumber; _liquidatedColl: BigNumber; _collGasCompensation: BigNumber; _BPDGasCompensation: BigNumber }>[];
  extractEvents(logs: Log[], name: "MPStakingAddressChanged"): _TypedLogDescription<{ _mpStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "MPTokenAddressChanged"): _TypedLogDescription<{ _mpTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "Redemption"): _TypedLogDescription<{ _attemptedBPDAmount: BigNumber; _actualBPDAmount: BigNumber; _RBTCSent: BigNumber; _RBTCFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SortedVaultsAddressChanged"): _TypedLogDescription<{ _sortedVaultsAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "VaultIndexUpdated"): _TypedLogDescription<{ _borrower: string; _newIndex: BigNumber }>[];
  extractEvents(logs: Log[], name: "VaultLiquidated"): _TypedLogDescription<{ _borrower: string; _debt: BigNumber; _coll: BigNumber; _operation: number }>[];
  extractEvents(logs: Log[], name: "VaultSnapshotsUpdated"): _TypedLogDescription<{ _B_RBTC: BigNumber; _B_BPDDebt: BigNumber }>[];
