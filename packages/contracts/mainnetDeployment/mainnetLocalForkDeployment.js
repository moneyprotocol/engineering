...
const RBTC_WHALE = "0x53d284357ec70ce289d6d64134dfac8e511c8a3d"
...
async function main() {
  ...
  console.log(`whale address from import: ${RBTC_WHALE}`)

  // Get the RBTC whale signer 
  const whale = await ethers.provider.getSigner(RBTC_WHALE)
  console.log(`whale addr : ${await whale.getAddress()}`)
  console.log(`whale RBTC balance: ${ await ethers.provider.getBalance(whale.getAddress())}`)
