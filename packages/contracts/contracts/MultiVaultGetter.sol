...
/*  Helper contract for grabbing Vault data for the front end. Not part of the core Moneyp system. */
contract MultiVaultGetter {
        ...
        internal view returns (CombinedVaultData[] memory _vaults)
    {
        ...
        for (uint idx = 0; idx < _count; ++idx) {
            ...
            (
                _vaults[idx].snapshotRBTC,
                _vaults[idx].snapshotBPDDebt
