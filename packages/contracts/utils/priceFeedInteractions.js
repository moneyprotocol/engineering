...
//    // Set the Vault Manager address in the testnet PriceFeed
//     // const res = await testnetPriceFeed.setVaultManagerAddress('0x405143dAe9a8a703a1fE82ad4B65BBFE5505AF63')
//     // res.wait()
//     const recordedVaultManagerAddressTestnet = await testnetPriceFeed.vaultManagerAddress()
//     console.log(`recorded VaultManager Address is ${recordedVaultManagerAddressTestnet}`)
...
//     Therefore, expected gas cost of a getLatestPrice() call is within a Vault function is (35k - 27.5k) 
