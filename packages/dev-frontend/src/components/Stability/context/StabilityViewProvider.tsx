...
import { MoneypStoreState, StabilityDeposit } from "@money-protocol/lib-base"
...
const select = ({ stabilityDeposit }: MoneypStoreState): StabilityDeposit => stabilityDeposit

export const StabilityViewProvider: React.FC = props => {
  const { children } = props
  const stabilityDeposit = useMoneypSelector(select)
